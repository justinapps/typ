...
<html lang="en">
  ...
  <div class="row">
   <div class="col-md-1 ">
    <img class="img-responsive" src="pc.jpg" id="134.206.17.31" />
   <img class="img-responsive" src="pc.jpg" id="134.206.17.32"  />
   <img class="img-responsive" src="pc.jpg" id="134.206.17.33"  />
   <img class="img-responsive" src="pc.jpg" id="134.206.17.34" />
    <img class="img-responsive" src="pc.jpg" id="134.206.17.35" />
	
 </div>
 <div class="col-md-1 ">
  </div>
 <div class="col-md-1 ">
    <img class="img-responsive" src="pc.jpg" id="134.206.17.42"/>
   <img class="img-responsive" src="pc.jpg" id="134.206.17.41"/>
   <img class="img-responsive" src="pc.jpg" id="134.206.17.40"/>
   <img class="img-responsive" src="pc.jpg" id="134.206.17.39"/>
    <img class="img-responsive" src="pc.jpg"id="134.206.17.38" />
	<img class="img-responsive" src="pc.jpg" id="134.206.17.37"/>
  ...
  <div class="col-md-1">
   ...
   <img class="img-responsive" src="pc.jpg" id="134.206.17.36"/>
		...
		if(isset($_POST['Next']))
		{
				...
				$sql = 'SELECT * FROM `Lab114` ORDER BY Time LIMIT 1';
				$result = mysql_query("SELECT * FROM `Lab114` ORDER BY Time LIMIT 1");
				//checck variable
				if (mysql_fetch_row($result)) 
				{
					...
					$search = mysql_query('SELECT COUNT(1) FROM Lab114');
					$length = mysql_result($search, 0, 0);
					 ...
					 //delete value when next student is clicked
					$sql ="DELETE FROM `justinas_qdb`.`Lab114` WHERE `Lab114`.`Lab114` ='$result'";
		...
		if(isset($_POST['end']))
		{
			$dbhost = 'localhost:3036';
				...
				if (mysql_fetch_row($result)) 
				{
					...
					mysql_query("DELETE FROM `justinas_qdb`.`Lab114`");
				}
		}	
	?>
<div id="hideMsg">
